...
渐进稳定分支的流水线（“silo”）视图:
![渐进稳定分支的工作流（“silo”）视图。](../images/lr-branches-2.png)
...
我们将会在 [分布式 Git](05-distributed-git/1-distributed-git.md) 中向你揭示更多有关分支工作流的细节，因此，请确保你阅读完那个章节之后，再来决定你的下个项目要使用什么样的分支策略（branching scheme）。
