...
注意这些远程仓库使用了不同的协议；我们将会在 [在服务器上搭建 Git](04-git-server/sections/git-on-a-server.md) 中了解关于它们的更多信息。
...
（我们将会在 [Git 分支](03-git-branching/1-git-branching.md) 中详细介绍什么是分支以及如何使用分支。）
...
如果你有一个分支设置为跟踪一个远程分支（阅读下一节与 [Git 分支](03-git-branching/1-git-branching.md) 了解更多信息），可以使用 `git pull` 命令来自动的抓取然后合并远程分支到当前分支。
...
阅读 [Git 分支](03-git-branching/1-git-branching.md) 了解如何推送到远程仓库服务器的详细信息。
