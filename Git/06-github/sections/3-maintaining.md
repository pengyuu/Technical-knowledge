...
.这是 `new repository` 表单.:![`new repository` 表单。](../images/newrepoform.png)
...
.版本库设置链接.:![版本库设置链接.](../images/reposettingslink.png)
...
就像我们在 [对项目做出贡献](06-github/sections/2-contributing.md) 说过的，现在你可以跟开启合并请求的人进行会话。
