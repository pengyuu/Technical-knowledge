...
我们在 [分支的新建与合并](03-git-branching/sections/basic-branching-and-merging.md) 介绍了解决合并冲突的一些基础知识，对于更复杂的冲突，Git 提供了几个工具来帮助你指出将会发生什么以及如何更好地处理冲突。
...
为了得到此次合并中包含的每一个分支的所有独立提交的列表，我们可以使用之前在 [选择修订版本](07-git-tools/sections/revision-selection.md) 学习的 `三点` 语法。
...
我们之前在 [重置揭密](07-git-tools/sections/reset.md) 已经介绍了 `reset`，所以现在指出这里发生了什么并不是很困难。
...
查阅 [变基](03-git-branching/sections/rebasing.md) 来了解更多可能发生的事情；用简单的话说就是如果其他人已经有你将要重写的提交，你应当避免使用 `reset`。
